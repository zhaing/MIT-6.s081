...
main(int argc, char *argv[])
{
  ...
  1a:	92278793          	add	a5,a5,-1758 # 938 <statistics+0xba>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	8dc50513          	add	a0,a0,-1828 # 908 <statistics+0x8a>
  ...
  6c:	8b850513          	add	a0,a0,-1864 # 920 <statistics+0xa2>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	87a50513          	add	a0,a0,-1926 # 930 <statistics+0xb2>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 460:	54c50513          	add	a0,a0,1356 # 9a8 <digits>
 464:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 564:	3f070713          	add	a4,a4,1008 # 950 <statistics+0xd2>
 ...
 5ee:	3beb8b93          	add	s7,s7,958 # 9a8 <digits>
 ...
 642:	30a90913          	add	s2,s2,778 # 948 <statistics+0xca>
        while(*s != 0){
...
free(void *ap)
{
 ...
 724:	2c87b783          	ld	a5,712(a5) # 9e8 <freep>
 ...
 74c:	00e6ea63          	bltu	a3,a4,760 <free+0x4a>
{
 ...
 78e:	24f73f23          	sd	a5,606(a4) # 9e8 <freep>
}
 792:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7c0:	22c53503          	ld	a0,556(a0) # 9e8 <freep>
 ...
 7e8:	20490913          	add	s2,s2,516 # 9e8 <freep>
  if(p == (char*)-1)
 7ec:	5afd                	li	s5,-1
 7ee:	a895                	j	862 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7f0:	00000797          	auipc	a5,0x0
 7f4:	20078793          	add	a5,a5,512 # 9f0 <base>
 7f8:	00000717          	auipc	a4,0x0
 7fc:	1ef73823          	sd	a5,496(a4) # 9e8 <freep>
 800:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 824:	1ca73423          	sd	a0,456(a4) # 9e8 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 898:	12c50513          	add	a0,a0,300 # 9c0 <digits+0x18>
 ...
 8ec:	0e858593          	add	a1,a1,232 # 9d0 <digits+0x28>
 8f0:	4509                	li	a0,2
