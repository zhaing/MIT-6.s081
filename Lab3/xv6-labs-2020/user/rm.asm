...
main(int argc, char *argv[])
{
  ...
  40:	83458593          	add	a1,a1,-1996 # 870 <statistics+0x88>
  44:	4509                	li	a0,2
  ...
  5e:	82e58593          	add	a1,a1,-2002 # 888 <statistics+0xa0>
  62:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ca:	54250513          	add	a0,a0,1346 # 908 <digits>
 3ce:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ce:	3e670713          	add	a4,a4,998 # 8b0 <statistics+0xc8>
 ...
 558:	3b4b8b93          	add	s7,s7,948 # 908 <digits>
 ...
 5ac:	30090913          	add	s2,s2,768 # 8a8 <statistics+0xc0>
        while(*s != 0){
...
free(void *ap)
{
 ...
 68e:	2be7b783          	ld	a5,702(a5) # 948 <freep>
 ...
 6b6:	00e6ea63          	bltu	a3,a4,6ca <free+0x4a>
{
 ...
 6f8:	24f73a23          	sd	a5,596(a4) # 948 <freep>
}
 6fc:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 72a:	22253503          	ld	a0,546(a0) # 948 <freep>
 ...
 752:	1fa90913          	add	s2,s2,506 # 948 <freep>
  if(p == (char*)-1)
 756:	5afd                	li	s5,-1
 758:	a895                	j	7cc <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 75a:	00000797          	auipc	a5,0x0
 75e:	1f678793          	add	a5,a5,502 # 950 <base>
 762:	00000717          	auipc	a4,0x0
 766:	1ef73323          	sd	a5,486(a4) # 948 <freep>
 76a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 78e:	1aa73f23          	sd	a0,446(a4) # 948 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 802:	12250513          	add	a0,a0,290 # 920 <digits+0x18>
 806:	00000097          	auipc	ra,0x0
 80a:	b1c080e7          	jalr	-1252(ra) # 322 <open>
  if(fd < 0) {
 ...
 828:	ad6080e7          	jalr	-1322(ra) # 2fa <read>
 ...
 83c:	ad2080e7          	jalr	-1326(ra) # 30a <close>
  return i;
}
 840:	8526                	mv	a0,s1
 ...
 856:	0de58593          	add	a1,a1,222 # 930 <digits+0x28>
 85a:	4509                	li	a0,2
 ...
 86a:	a7c080e7          	jalr	-1412(ra) # 2e2 <exit>
