...
wc(int fd, char *name)
{
  ...
  32:	a4ad8d93          	add	s11,s11,-1462 # a78 <buf>
    for(i=0; i<n; i++){
      c++;
      if(buf[i] == '\n')
  36:	4aa9                	li	s5,10
  ...
  3c:	950a0a13          	add	s4,s4,-1712 # 988 <statistics+0x8c>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  8e:	9ee48493          	add	s1,s1,-1554 # a78 <buf>
  ...
  aa:	8fa50513          	add	a0,a0,-1798 # 9a0 <statistics+0xa4>
  ...
  d8:	8bc50513          	add	a0,a0,-1860 # 990 <statistics+0x94>
...
main(int argc, char *argv[])
{
 ...
 154:	86058593          	add	a1,a1,-1952 # 9b0 <statistics+0xb4>
 158:	4501                	li	a0,0
 ...
 174:	84850513          	add	a0,a0,-1976 # 9b8 <statistics+0xbc>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4de:	55650513          	add	a0,a0,1366 # a30 <digits>
 4e2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5e2:	3fa70713          	add	a4,a4,1018 # 9d8 <statistics+0xdc>
 ...
 66c:	3c8b8b93          	add	s7,s7,968 # a30 <digits>
 ...
 6c0:	31490913          	add	s2,s2,788 # 9d0 <statistics+0xd4>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7a2:	2d27b783          	ld	a5,722(a5) # a70 <freep>
 ...
 7ca:	00e6ea63          	bltu	a3,a4,7de <free+0x4a>
{
 ...
 80c:	26f73423          	sd	a5,616(a4) # a70 <freep>
}
 810:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 83e:	23653503          	ld	a0,566(a0) # a70 <freep>
 ...
 866:	20e90913          	add	s2,s2,526 # a70 <freep>
  if(p == (char*)-1)
 86a:	5afd                	li	s5,-1
 86c:	a895                	j	8e0 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 86e:	00000797          	auipc	a5,0x0
 872:	40a78793          	add	a5,a5,1034 # c78 <base>
 876:	00000717          	auipc	a4,0x0
 87a:	1ef73d23          	sd	a5,506(a4) # a70 <freep>
 87e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8a2:	1ca73923          	sd	a0,466(a4) # a70 <freep>
      return (void*)(p + 1);
...
{
 8fc:	7179                	add	sp,sp,-48
 8fe:	f406                	sd	ra,40(sp)
 900:	f022                	sd	s0,32(sp)
 902:	ec26                	sd	s1,24(sp)
 904:	e84a                	sd	s2,16(sp)
 906:	e44e                	sd	s3,8(sp)
 908:	e052                	sd	s4,0(sp)
 90a:	1800                	add	s0,sp,48
 90c:	8a2a                	mv	s4,a0
 90e:	892e                	mv	s2,a1
  int fd, i, n;
 ...
 916:	13650513          	add	a0,a0,310 # a48 <digits+0x18>
 91a:	00000097          	auipc	ra,0x0
 91e:	b1c080e7          	jalr	-1252(ra) # 436 <open>
  if(fd < 0) {
 922:	04054263          	bltz	a0,966 <statistics+0x6a>
 926:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 928:	4481                	li	s1,0
 92a:	03205063          	blez	s2,94a <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 92e:	4099063b          	subw	a2,s2,s1
 932:	009a05b3          	add	a1,s4,s1
 936:	854e                	mv	a0,s3
 938:	00000097          	auipc	ra,0x0
 93c:	ad6080e7          	jalr	-1322(ra) # 40e <read>
 940:	00054563          	bltz	a0,94a <statistics+0x4e>
      break;
    }
    i += n;
 944:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 946:	ff24c4e3          	blt	s1,s2,92e <statistics+0x32>
  }
  close(fd);
 94a:	854e                	mv	a0,s3
 94c:	00000097          	auipc	ra,0x0
 950:	ad2080e7          	jalr	-1326(ra) # 41e <close>
  return i;
}
 954:	8526                	mv	a0,s1
 ...
 96a:	0f258593          	add	a1,a1,242 # a58 <digits+0x28>
 96e:	4509                	li	a0,2
 970:	00000097          	auipc	ra,0x0
 974:	dc0080e7          	jalr	-576(ra) # 730 <fprintf>
      exit(1);
 978:	4505                	li	a0,1
 97a:	00000097          	auipc	ra,0x0
 97e:	a7c080e7          	jalr	-1412(ra) # 3f6 <exit>
