...
main(void)
{
  ...
  12:	8fa50513          	add	a0,a0,-1798 # 908 <statistics+0x8a>
  ...
  3a:	8ea90913          	add	s2,s2,-1814 # 920 <statistics+0xa2>
  3e:	854a                	mv	a0,s2
  ...
  6e:	90650513          	add	a0,a0,-1786 # 970 <statistics+0xf2>
  ...
  8c:	88050513          	add	a0,a0,-1920 # 908 <statistics+0x8a>
  ...
  a0:	87450513          	add	a0,a0,-1932 # 910 <statistics+0x92>
  a4:	00000097          	auipc	ra,0x0
  a8:	31c080e7          	jalr	796(ra) # 3c0 <mknod>
    open("console", O_RDWR);
  ac:	4589                	li	a1,2
  ae:	00001517          	auipc	a0,0x1
  b2:	85a50513          	add	a0,a0,-1958 # 908 <statistics+0x8a>
  b6:	00000097          	auipc	ra,0x0
  ba:	302080e7          	jalr	770(ra) # 3b8 <open>
  be:	b795                	j	22 <main+0x22>
      printf("init: fork failed\n");
  c0:	00001517          	auipc	a0,0x1
  c4:	87850513          	add	a0,a0,-1928 # 938 <statistics+0xba>
  c8:	00000097          	auipc	ra,0x0
  cc:	618080e7          	jalr	1560(ra) # 6e0 <printf>
      exit(1);
  d0:	4505                	li	a0,1
  ...
  de:	94658593          	add	a1,a1,-1722 # a20 <argv>
  e2:	00001517          	auipc	a0,0x1
  e6:	86e50513          	add	a0,a0,-1938 # 950 <statistics+0xd2>
  ea:	00000097          	auipc	ra,0x0
  ee:	2c6080e7          	jalr	710(ra) # 3b0 <exec>
      printf("init: exec sh failed\n");
  f2:	00001517          	auipc	a0,0x1
  f6:	86650513          	add	a0,a0,-1946 # 958 <statistics+0xda>
  fa:	00000097          	auipc	ra,0x0
  fe:	5e6080e7          	jalr	1510(ra) # 6e0 <printf>
      exit(1);
 102:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 460:	59450513          	add	a0,a0,1428 # 9f0 <digits>
 464:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 564:	43870713          	add	a4,a4,1080 # 998 <statistics+0x11a>
 ...
 5ee:	406b8b93          	add	s7,s7,1030 # 9f0 <digits>
 ...
 642:	35290913          	add	s2,s2,850 # 990 <statistics+0x112>
        while(*s != 0){
...
free(void *ap)
{
 ...
 724:	3107b783          	ld	a5,784(a5) # a30 <freep>
 ...
 74c:	00e6ea63          	bltu	a3,a4,760 <free+0x4a>
{
 ...
 78e:	2af73323          	sd	a5,678(a4) # a30 <freep>
}
 792:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7c0:	27453503          	ld	a0,628(a0) # a30 <freep>
 ...
 7e8:	24c90913          	add	s2,s2,588 # a30 <freep>
  if(p == (char*)-1)
 7ec:	5afd                	li	s5,-1
 7ee:	a895                	j	862 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7f0:	00000797          	auipc	a5,0x0
 7f4:	24878793          	add	a5,a5,584 # a38 <base>
 7f8:	00000717          	auipc	a4,0x0
 7fc:	22f73c23          	sd	a5,568(a4) # a30 <freep>
 800:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 824:	20a73823          	sd	a0,528(a4) # a30 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 898:	07c50513          	add	a0,a0,124 # 910 <statistics+0x92>
 89c:	00000097          	auipc	ra,0x0
 8a0:	b1c080e7          	jalr	-1252(ra) # 3b8 <open>
  if(fd < 0) {
 8a4:	04054263          	bltz	a0,8e8 <statistics+0x6a>
 8a8:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 8aa:	4481                	li	s1,0
 8ac:	03205063          	blez	s2,8cc <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 8b0:	4099063b          	subw	a2,s2,s1
 8b4:	009a05b3          	add	a1,s4,s1
 8b8:	854e                	mv	a0,s3
 8ba:	00000097          	auipc	ra,0x0
 8be:	ad6080e7          	jalr	-1322(ra) # 390 <read>
 8c2:	00054563          	bltz	a0,8cc <statistics+0x4e>
      break;
    }
    i += n;
 8c6:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 8c8:	ff24c4e3          	blt	s1,s2,8b0 <statistics+0x32>
  }
  close(fd);
 8cc:	854e                	mv	a0,s3
 8ce:	00000097          	auipc	ra,0x0
 8d2:	ad2080e7          	jalr	-1326(ra) # 3a0 <close>
  return i;
}
 8d6:	8526                	mv	a0,s1
 ...
 8e0:	69a2                	ld	s3,8(sp)
 8e2:	6a02                	ld	s4,0(sp)
 8e4:	6145                	add	sp,sp,48
 8e6:	8082                	ret
      fprintf(2, "stats: open failed\n");
 8e8:	00000597          	auipc	a1,0x0
 8ec:	12058593          	add	a1,a1,288 # a08 <digits+0x18>
 8f0:	4509                	li	a0,2
 8f2:	00000097          	auipc	ra,0x0
 8f6:	dc0080e7          	jalr	-576(ra) # 6b2 <fprintf>
      exit(1);
 8fa:	4505                	li	a0,1
 8fc:	00000097          	auipc	ra,0x0
 900:	a7c080e7          	jalr	-1412(ra) # 378 <exit>
