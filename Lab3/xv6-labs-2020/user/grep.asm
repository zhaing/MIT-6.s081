...
000000000000011a <grep>:
{
 ...
 140:	a4ca8a93          	add	s5,s5,-1460 # b88 <buf>
 ...
 1ba:	9d250513          	add	a0,a0,-1582 # b88 <buf>
...
00000000000001ec <main>:
{
 ...
 25e:	84e58593          	add	a1,a1,-1970 # aa8 <statistics+0x8c>
 262:	4509                	li	a0,2
 ...
 294:	83850513          	add	a0,a0,-1992 # ac8 <statistics+0xac>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5fe:	54650513          	add	a0,a0,1350 # b40 <digits>
 602:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 702:	3ea70713          	add	a4,a4,1002 # ae8 <statistics+0xcc>
 ...
 78c:	3b8b8b93          	add	s7,s7,952 # b40 <digits>
 ...
 7e0:	30490913          	add	s2,s2,772 # ae0 <statistics+0xc4>
        while(*s != 0){
...
free(void *ap)
{
 ...
 8c2:	2c27b783          	ld	a5,706(a5) # b80 <freep>
 ...
 8ea:	00e6ea63          	bltu	a3,a4,8fe <free+0x4a>
{
 ...
 92c:	24f73c23          	sd	a5,600(a4) # b80 <freep>
}
 930:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 95e:	22653503          	ld	a0,550(a0) # b80 <freep>
 ...
 986:	1fe90913          	add	s2,s2,510 # b80 <freep>
  if(p == (char*)-1)
 98a:	5afd                	li	s5,-1
 98c:	a895                	j	a00 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 98e:	00000797          	auipc	a5,0x0
 992:	5fa78793          	add	a5,a5,1530 # f88 <base>
 996:	00000717          	auipc	a4,0x0
 99a:	1ef73523          	sd	a5,490(a4) # b80 <freep>
 99e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 9c2:	1ca73123          	sd	a0,450(a4) # b80 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 a36:	12650513          	add	a0,a0,294 # b58 <digits+0x18>
 a3a:	00000097          	auipc	ra,0x0
 a3e:	b1c080e7          	jalr	-1252(ra) # 556 <open>
  if(fd < 0) {
 a42:	04054263          	bltz	a0,a86 <statistics+0x6a>
 a46:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 a48:	4481                	li	s1,0
 a4a:	03205063          	blez	s2,a6a <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 a4e:	4099063b          	subw	a2,s2,s1
 a52:	009a05b3          	add	a1,s4,s1
 a56:	854e                	mv	a0,s3
 a58:	00000097          	auipc	ra,0x0
 a5c:	ad6080e7          	jalr	-1322(ra) # 52e <read>
 a60:	00054563          	bltz	a0,a6a <statistics+0x4e>
      break;
    }
    i += n;
 a64:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 a66:	ff24c4e3          	blt	s1,s2,a4e <statistics+0x32>
  }
  close(fd);
 a6a:	854e                	mv	a0,s3
 a6c:	00000097          	auipc	ra,0x0
 a70:	ad2080e7          	jalr	-1326(ra) # 53e <close>
  return i;
}
 a74:	8526                	mv	a0,s1
 ...
 a7e:	69a2                	ld	s3,8(sp)
 a80:	6a02                	ld	s4,0(sp)
 a82:	6145                	add	sp,sp,48
 a84:	8082                	ret
      fprintf(2, "stats: open failed\n");
 a86:	00000597          	auipc	a1,0x0
 a8a:	0e258593          	add	a1,a1,226 # b68 <digits+0x28>
 a8e:	4509                	li	a0,2
 a90:	00000097          	auipc	ra,0x0
 a94:	dc0080e7          	jalr	-576(ra) # 850 <fprintf>
      exit(1);
 a98:	4505                	li	a0,1
 a9a:	00000097          	auipc	ra,0x0
 a9e:	a7c080e7          	jalr	-1412(ra) # 516 <exit>
