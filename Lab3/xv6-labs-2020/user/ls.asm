...
fmtname(char *path)
{
  ...
  6a:	b7a98993          	add	s3,s3,-1158 # be0 <buf.0>
...
ls(char *path)
{
 ...
 124:	9d850513          	add	a0,a0,-1576 # af8 <statistics+0xb8>
 ...
 162:	96a58593          	add	a1,a1,-1686 # ac8 <statistics+0x88>
 166:	4509                	li	a0,2
 ...
 178:	96c58593          	add	a1,a1,-1684 # ae0 <statistics+0xa0>
 17c:	4509                	li	a0,2
 ...
 1aa:	96250513          	add	a0,a0,-1694 # b08 <statistics+0xc8>
 ...
 1ee:	936a0a13          	add	s4,s4,-1738 # b20 <statistics+0xe0>
        printf("ls: cannot stat %s\n", buf);
 1f2:	00001a97          	auipc	s5,0x1
 1f6:	8eea8a93          	add	s5,s5,-1810 # ae0 <statistics+0xa0>
...
main(int argc, char *argv[])
{
 ...
 2b8:	87c50513          	add	a0,a0,-1924 # b30 <statistics+0xf0>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 622:	57a50513          	add	a0,a0,1402 # b98 <digits>
 626:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 726:	41e70713          	add	a4,a4,1054 # b40 <statistics+0x100>
 ...
 7b0:	3ecb8b93          	add	s7,s7,1004 # b98 <digits>
 ...
 804:	33890913          	add	s2,s2,824 # b38 <statistics+0xf8>
        while(*s != 0){
...
free(void *ap)
{
 ...
 8e6:	2f67b783          	ld	a5,758(a5) # bd8 <freep>
 ...
 90e:	00e6ea63          	bltu	a3,a4,922 <free+0x4a>
{
 ...
 950:	28f73623          	sd	a5,652(a4) # bd8 <freep>
}
 954:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 982:	25a53503          	ld	a0,602(a0) # bd8 <freep>
 ...
 9aa:	23290913          	add	s2,s2,562 # bd8 <freep>
  if(p == (char*)-1)
 9ae:	5afd                	li	s5,-1
 9b0:	a895                	j	a24 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 9b2:	00000797          	auipc	a5,0x0
 9b6:	23e78793          	add	a5,a5,574 # bf0 <base>
 9ba:	00000717          	auipc	a4,0x0
 9be:	20f73f23          	sd	a5,542(a4) # bd8 <freep>
 9c2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 9e6:	1ea73b23          	sd	a0,502(a4) # bd8 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 a5a:	15a50513          	add	a0,a0,346 # bb0 <digits+0x18>
 a5e:	00000097          	auipc	ra,0x0
 a62:	b1c080e7          	jalr	-1252(ra) # 57a <open>
  if(fd < 0) {
 a66:	04054263          	bltz	a0,aaa <statistics+0x6a>
 a6a:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 a6c:	4481                	li	s1,0
 a6e:	03205063          	blez	s2,a8e <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 a72:	4099063b          	subw	a2,s2,s1
 a76:	009a05b3          	add	a1,s4,s1
 a7a:	854e                	mv	a0,s3
 a7c:	00000097          	auipc	ra,0x0
 a80:	ad6080e7          	jalr	-1322(ra) # 552 <read>
 a84:	00054563          	bltz	a0,a8e <statistics+0x4e>
      break;
    }
    i += n;
 a88:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 a8a:	ff24c4e3          	blt	s1,s2,a72 <statistics+0x32>
  }
  close(fd);
 a8e:	854e                	mv	a0,s3
 a90:	00000097          	auipc	ra,0x0
 a94:	ad2080e7          	jalr	-1326(ra) # 562 <close>
  return i;
}
 a98:	8526                	mv	a0,s1
 ...
 aa2:	69a2                	ld	s3,8(sp)
 aa4:	6a02                	ld	s4,0(sp)
 aa6:	6145                	add	sp,sp,48
 aa8:	8082                	ret
      fprintf(2, "stats: open failed\n");
 aaa:	00000597          	auipc	a1,0x0
 aae:	11658593          	add	a1,a1,278 # bc0 <digits+0x28>
 ab2:	4509                	li	a0,2
 ab4:	00000097          	auipc	ra,0x0
 ab8:	dc0080e7          	jalr	-576(ra) # 874 <fprintf>
      exit(1);
 abc:	4505                	li	a0,1
 abe:	00000097          	auipc	ra,0x0
 ac2:	a7c080e7          	jalr	-1412(ra) # 53a <exit>
